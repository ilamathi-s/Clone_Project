...
function Homepage() {
  return (
    ...
    <div className='home-font italic font-bolder'>
        <h1 className='px-14'>Future Proof Your</h1>
        <h1>Career With <span className='color'>LetsUpgrade</span></h1>
    </div>
    ...
    <div className='flex flex-wrap px-28'>
     ...
     <div className='spacing flex flex-col  space-y-8 '>
      ...
      <HomeCard2 image={Home_4} heading="B.Des in UI UX Program" button="Apply Now"/></div>
   </div></div>
  )
}
