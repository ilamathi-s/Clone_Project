...
function certifipage() {
  return (
    <div className='justify-center px-48'>
        <div className="card " >
         ...
         <div className='flex justify-center gap-3 mt-20'>
            ...
            <Certificard image={Certify_5}  detail="17.9k Enrolled 23 Dec" title="JioCinema React Clone" /></div>
            <a href="#" className='link-warning link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover'>view all certificate program<FontAwesomeIcon icon={faGreaterThan} className='px-2'/></a>
         </div>
        </div>
    </div>
  )
